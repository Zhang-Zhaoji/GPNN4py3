...
dataset = 'vcoco'
project_root = 'e:/gpnn/modernGPNN'
...
def main(args):
    ...
    model = dynamic_model.GPNN(model_args)
...
def parse_arguments():
    ...
    # dataset setting
    parser.add_argument('--dataset',type= str, default='cad',help = 'should be hico, vcoco or cad')
    # Path settings
    ...
    # Accelerating
    parser.add_argument('--num_workers', type=int, default=0, help='num workers to load the data.')
